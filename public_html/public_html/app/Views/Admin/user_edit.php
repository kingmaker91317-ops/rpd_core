...
<div class="row justify-content-center pt-3">
    ...
    <div class="col-lg-8 mb-3">
        <div class="card mb-5">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php if ($user->level == 1 || ($user->level == 3 && $target->id_users != $user->id_users)): ?>
                    <div class="col-md-6 mb-2">
                        <label for="level" class="form-label">Role</label>
                        <?php $sel_level = ['' => '&mdash; Select Roles &mdash;', '1' => 'Admin', '2' => 'Reseller', '3' => 'Tenant']; ?>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <?php $sel_status = ['' => '&mdash; Select Status &mdash;', '0' => 'Banned/Locked', '1' => 'Active']; ?>
                    ...
                    <?php if ($user->level == 1): // Only Admin can edit uplink ?>
                    <div class="col-md-6 mb-2">
                    ...
                    <div class="col-md-12 mt-2 d-flex justify-content-between">
                        ...
                        <?php if (($user->level == 1 || ($user->level == 3 && $target->level == 2)) && 
                                 $target->id_users != $user->id_users): ?>
                        <a href="<?= site_url('admin/user_delete/'.$target->id_users) ?>" 
        ...
        <p class="text-muted text-center">
            <a href="<?= site_url('admin/manage-users') ?>" class="py-1 px-2 bg-white text-muted"><small><i class="bi bi-arrow-left"></i> Back to User Management</small></a>
        </p>
    </div>
</div>
<?= $this->endSection() ?>