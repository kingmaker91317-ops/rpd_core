    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow-sm mb-5">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    <input type="hidden" class="form-control mt-2" name="ip" value="<?php echo $_SERVER['HTTP_USER_AGENT'] ?? 'Unknown'; ?>" id="ip" aria-describedby="help-ip" required>
        ...
        <p class="text-center text-muted after-card">
            <small class="bg-white px-auto p-2 rounded">
                ...
                <a href="<?= site_url('register') ?>" class="text-dark">Sign Up</a>
            </small>
        </p>
    </div>
</div>
